...
describe('marketing events', () => {
  it('accepts the privacy-safe conversion events used by the landing page', () => {
    ...
    expect(MARKETING_EVENTS).toContain('contact_form_open')
    expect(MARKETING_EVENTS).toContain('diagnostic_cta_click')
    expect(MARKETING_EVENTS).toContain('contact_details_open')
