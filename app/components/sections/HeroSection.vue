...
<template>
    <section
        id="hero"
        class="relative min-h-screen w-full flex items-center justify-center overflow-hidden hero-frame"
    >
        ...
        <div class="relative z-10 section-container text-center pt-28 pb-20">
            <div class="max-w-4xl mx-auto">
                ...
                >
                    <span
                        class="w-1.5 h-1.5 rounded-full bg-violet-500 animate-pulse"
                    />
                    {{ t("hero.badge") }}
                </div>
                ...
                <h1
                    ...
                    :enter="{
                        opacity: 1,
                        y: 0,
                        transition: { delay: 220, duration: 850 },
                    }"
                ...
                >
                    ...
                    <span class="block section-heading-gradient">
                ...
                <p
                    ...
                    :enter="{
                        opacity: 1,
                        y: 0,
                        transition: { delay: 320, duration: 700 },
                    }"
                    class="text-base sm:text-lg md:text-xl text-gray-600 dark:text-white/75 mb-10 leading-relaxed max-w-2xl mx-auto"
                >
                ...
                <div
                    ...
                    :enter="{
                        opacity: 1,
                        y: 0,
                        transition: { delay: 420, duration: 650 },
                    }"
        ...
        <div
            class="absolute inset-0 bg-gradient-to-t from-white/70 via-transparent to-white/30 dark:from-[#030303] dark:via-transparent dark:to-[#030303]/70 pointer-events-none"
        />
    </section>
</template>
