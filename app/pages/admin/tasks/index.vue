  ...
  <div class="space-y-5">
    <section class="relative overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-4 shadow-sm dark:border-white/[0.08] dark:bg-[#111118] sm:px-5">
      ...
      <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button class="inline-flex h-10 shrink-0 items-center justify-center rounded-lg bg-gradient-brand px-4 text-xs font-semibold text-white shadow-glow-sm transition hover:opacity-90" @click="openNew">Nouvelle</button>
      </div>
    </section>
