...
const tab = ref<'contacts' | 'prospects'>('contacts')
const search = ref('')
  ...
  <div class="space-y-5">
    ...
    <section class="rounded-lg border border-gray-200 bg-white p-3 shadow-sm dark:border-white/[0.08] dark:bg-[#111118] sm:p-3.5">
      <div class="flex flex-wrap items-center gap-2.5">
        ...
        <select v-model="sortBy" class="input-field w-auto shrink-0">
          <option value="recent">Plus recents</option>
          <option value="name">Nom (A-Z)</option>
        </select>

        <div class="inline-flex shrink-0 rounded-lg border border-gray-200 p-1 dark:border-white/[0.12] sm:ml-auto">
          <button
